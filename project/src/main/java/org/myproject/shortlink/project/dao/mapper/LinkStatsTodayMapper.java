...
public interface LinkStatsTodayMapper extends BaseMapper<LinkStatsTodayDO> {
    ...
    @Insert("INSERT INTO t_link_stats_today (full_short_url, gid, date, today_pv, today_uv, today_uip, create_time, update_time, del_flag)" +
            "VALUES(#{linkTodayStats.fullShortUrl}, #{linkTodayStats.gid}, #{linkTodayStats.date}, #{linkTodayStats.todayPv}, #{linkTodayStats.todayUv}," +
            " #{linkTodayStats.todayUip}, NOW(), NOW(), 0) " +
